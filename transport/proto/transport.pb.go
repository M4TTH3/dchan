...
const file_transport_proto_rawDesc = "" +
	...
	"\x11LOG_CONFIGURATION\x10\x05\"\xef\x01\n" +
	"\x14AppendEntriesRequest\x12)\n" +
	"\n" +
	"rpc_header\x18\x01 \x01(\v2\n" +
	".RPCHeaderR\trpcHeader\x12\x12\n" +
	"\x04term\x18\x02 \x01(\x04R\x04term\x12$\n" +
	"\x0eprev_log_entry\x18\x03 \x01(\x04R\fprevLogEntry\x12\"\n" +
	"\rprev_log_term\x18\x04 \x01(\x04R\vprevLogTerm\x12\x1e\n" +
	"\aentries\x18\x05 \x03(\v2\x04.LogR\aentries\x12.\n" +
	"\x13leader_commit_index\x18\x06 \x01(\x04R\x11leaderCommitIndex\"\xb5\x01\n" +
	...
	"\x10no_retry_backoff\x18\x05 \x01(\bR\x0enoRetryBackoff\"\xce\x01\n" +
	...
	"\x13leadership_transfer\x18\x05 \x01(\bR\x12leadershipTransfer\"\x84\x01\n" +
	...
	"\n" +
	"rpc_header\x18\x01 \x01(\v2\n" +
	".RPCHeaderR\trpcHeader\"?\n" +
	"\x12TimeoutNowResponse\x12)\n" +
	"\n" +
	"rpc_header\x18\x01 \x01(\v2\n" +
	".RPCHeaderR\trpcHeader\"\xf9\x02\n" +
	"\x16InstallSnapshotRequest\x12)\n" +
	"\n" +
	"rpc_header\x18\x01 \x01(\v2\n" +
	".RPCHeaderR\trpcHeader\x12)\n" +
	...
	"\asuccess\x18\x03 \x01(\bR\asuccess\"\xa0\x01\n" +
	...
	"\x04term\x18\x02 \x01(\x04R\x04term\x12$\n" +
	"\x0elast_log_index\x18\x03 \x01(\x04R\flastLogIndex\x12\"\n" +
	"\rlast_log_term\x18\x04 \x01(\x04R\vlastLogTerm\"q\n" +
	"\x16RequestPreVoteResponse\x12)\n" +
	"\n" +
	"rpc_header\x18\x01 \x01(\v2\n" +
	".RPCHeaderR\trpcHeader\x12\x12\n" +
	"\x04term\x18\x02 \x01(\x04R\x04term\x12\x18\n" +
	"\agranted\x18\x03 \x01(\bR\agranted2\xa3\x03\n" +
	"\rRaftTransport\x12L\n" +
	"\x15AppendEntriesPipeline\x12\x15.AppendEntriesRequest\x1a\x16.AppendEntriesResponse\"\x00(\x010\x01\x12@\n" +
	"\rAppendEntries\x12\x15.AppendEntriesRequest\x1a\x16.AppendEntriesResponse\"\x00\x12:\n" +
	"\vRequestVote\x12\x13.RequestVoteRequest\x1a\x14.RequestVoteResponse\"\x00\x127\n" +
	"\n" +
	"TimeoutNow\x12\x12.TimeoutNowRequest\x1a\x13.TimeoutNowResponse\"\x00\x12H\n" +
	"\x0fInstallSnapshot\x12\x17.InstallSnapshotRequest\x1a\x18.InstallSnapshotResponse\"\x00(\x01\x12C\n" +
	"\x0eRequestPreVote\x12\x16.RequestPreVoteRequest\x1a\x17.RequestPreVoteResponse\"\x00B)Z'github.com/m4tth3/dchan/transport/protob\x06proto3"
